...
/* JavaScript content from js/characterCreate.js in folder common */
...
function confirmName() {
	...
	if(fName.length > 9) alert("First name too long");
	if(lName.length > 9) alert("Last name too long");
	
	if(!(fName.length==0) && !(fName.length > 9) && !(lName.length > 9)) {
